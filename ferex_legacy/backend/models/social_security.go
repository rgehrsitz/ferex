...
// FRADetail stores Full Retirement Age in years and months.
type FRADetail struct {
	Years  int
	Months int
}
...
type SocialSecurityCalculationResult struct {
	...
	// Time-series projection of COLA-adjusted annual benefits
	ProjectedAnnualBenefitTimeline []float64 `json:"projectedAnnualBenefitTimeline,omitempty"`
}
